...
<html lang="en">
	<head>
		<title>Ben Ventura CS008 - Better</title>
		<meta charset="UTF-8">
	...
	<body>
		<main>
			...
			<h2>Narcan can save lives - Data from a 2014 CDC Study</h2>
 			...
 			<h3>Who Provided Narcan according to the Study</h3>
 			<table>
 				<tr>
 			...
 			<figure>
 				<img src="http://images.huffingtonpost.com/2015-06-22-1434997127-3023677-m6423a2f1.gif" alt="The number of Narcan providers nearly doubled between 2010 and 2014.">
